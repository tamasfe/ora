...
macro_rules! serialize {
    ($expr:expr) => {
        ::rkyv::api::high::to_bytes_in::<_, ::rkyv::rancor::Error>($expr, Vec::<u8>::new())
    };
}
...
pub(crate) fn deserialize_systemtime(ts: ArchivedDuration) -> SystemTime {
    SystemTime::UNIX_EPOCH + ts.into()
}
